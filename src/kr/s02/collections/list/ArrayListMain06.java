...
public class ArrayListMain06 {
	public static void main(String[] args) {
		...
		System.out.println("첫번째 사과 : " + index1); //첫번째 사과가 어디있는지 검색
		
		int index2 = list.lastIndexOf("사과");
		System.out.println("마지막 사과 : "+ index2); //마지막 사과가 어디있는지 검색
		
		int index3 = list.indexOf("망고");
		System.out.println("망고 : "+ index3); //존재하지 않아서 -1 출력
		
		boolean f = list.contains("망고"); //위치탐색X
